...
urlpatterns = patterns('',
	...
	url(r'^product/suv/land-cruiser/?', 'portal.views.product_land_cruiser'),
	url(r'^product/suv/new-fortuner/?', 'portal.views.product_new_fortuner'),
	url(r'^product/suv/new-rush/?', 'portal.views.product_new_rush'),

	url(r'^product/commercial/?$', 'portal.views.product_commercial'),
	url(r'^product/commercial/hiace/?', 'portal.views.product_hiace'),
	url(r'^product/commercial/dyna/?', 'portal.views.product_dyna'),
	url(r'^product/commercial/hilux-d-cab/?', 'portal.views.product_hilux_d_cab'),
	url(r'^product/commercial/hilux-s-cab/?', 'portal.views.product_hilux_s_cab'),

	url(r'^product/sport/?$', 'portal.views.product_sport'),
	url(r'^product/sport/toyota-86/?', 'portal.views.product_toyota_86'),

	url(r'^product/hybrid/?$', 'portal.views.product_hybrid'),
	url(r'^product/hybrid/prius/?', 'portal.views.product_prius'),
	url(r'^product/hybrid/camry-hybrid/?', 'portal.views.product_camry_hybrid'),
)